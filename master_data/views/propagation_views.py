...
class PropagationJobViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def errors(self, request, pk=None):
        ...
        job = self.get_object()
        errors = job.errors.all().select_related('string', 'string_detail', 'resolved_by')
...
class EnhancedStringDetailViewSet(viewsets.ModelViewSet):
    ...
    def _enhanced_update(self, request, partial=False, *args, **kwargs):
        ...
        propagation_depth = serializer.validated_data.pop('propagation_depth', 10)
        ...
        try:
            ...
            logger.error(f"Enhanced update failed for StringDetail {instance.id}: {str(e)}")
            return Response({
    ...
    def analyze_impact(self, request):
        ...
        serializer = serializers.PropagationImpactRequestSerializer(data=request.data)
    ...
    def batch_update(self, request):
        ...
        serializer = serializers.StringDetailBatchUpdateRequestSerializer(data=request.data)
        if serializer.is_valid():
            try:
